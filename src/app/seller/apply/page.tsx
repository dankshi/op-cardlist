...
export default function SellerApplyPage() {
  ...
  if (profile?.is_seller && profile?.seller_approved) {
    return (
      <div className="max-w-2xl mx-auto">
        <div className="bg-zinc-900 light:bg-white border border-zinc-800 light:border-gray-200 rounded-2xl p-8 text-center">
          <div className="w-16 h-16 bg-green-500/10 rounded-full flex items-center justify-center mx-auto mb-4">
            <svg className="w-8 h-8 text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
            </svg>
          </div>
          <h1 className="text-2xl font-bold text-zinc-100 light:text-gray-900">You&apos;re already a seller!</h1>
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h1 className="text-3xl font-bold text-zinc-100 light:text-gray-900 mb-8">Become a Seller</h1>

      <div className="bg-zinc-900 light:bg-white border border-zinc-800 light:border-gray-200 rounded-2xl p-8">
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-zinc-100 light:text-gray-900 mb-4">Why sell on NOMI Market?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              <div key={perk.title} className="flex gap-3 p-3 rounded-lg bg-zinc-800 light:bg-gray-100">
                ...
                <div>
                  <p className="font-medium text-zinc-100 light:text-gray-900">{perk.title}</p>
                  <p className="text-sm text-zinc-400 light:text-gray-500">{perk.desc}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="border-t border-zinc-700 light:border-gray-300 pt-6">
          <h3 className="font-medium text-zinc-100 light:text-gray-900 mb-4">Seller Agreement</h3>
          <div className="p-4 rounded-lg bg-zinc-800 light:bg-gray-100 text-sm text-zinc-300 light:text-gray-600 space-y-2 mb-6">
            <p>By becoming a seller on NOMI Market, you agree to:</p>
            <ul className="list-disc list-inside space-y-1 text-zinc-400 light:text-gray-500">
