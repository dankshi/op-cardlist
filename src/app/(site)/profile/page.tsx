      ...
      <div className="bg-white border border-zinc-200 rounded-2xl p-8">
        ...
        {profile.bio && (
          <div className="mb-6">
            ...
            <p className="text-zinc-800">{profile.bio}</p>
          </div>
        )}

        <div className="grid grid-cols-3 gap-4 mb-6">
          <div className="bg-zinc-100 rounded-lg p-4 text-center">
            <p className="text-2xl font-bold text-zinc-900">{profile.total_sales}</p>
          ...
          <div className="bg-zinc-100 rounded-lg p-4 text-center">
            <p className="text-2xl font-bold text-zinc-900">{profile.rating_count}</p>
        ...
        {!profile.is_seller && (
          <div className="mt-6 p-4 bg-orange-500/5 border border-orange-500/20 rounded-lg">
            <p className="text-zinc-600 text-sm">
              ...
              <Link href="/seller/apply" className="text-orange-400 hover:text-orange-600 font-medium">
                Become a seller
              </Link>
            </p>
          </div>
