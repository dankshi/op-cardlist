...
export default function SellPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h1 className="text-3xl font-bold text-zinc-900 mb-8">Sell a Card</h1>
      ...
      <div className="bg-white border border-zinc-200 rounded-2xl p-8">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            {selectedCard ? (
              <div className="flex items-center gap-4 p-3 rounded-lg bg-zinc-100 border border-zinc-200">
                <img src={selectedCard.imageUrl} alt="" className="w-16 h-22 object-contain rounded" />
                <div>
                  <p className="font-medium text-zinc-900">{selectedCard.name}</p>
                ...
                <button
                  ...
                  className="ml-auto text-zinc-500 hover:text-zinc-600 cursor-pointer"
                >
                  Change
                </button>
              </div>
              ...
              <div className="relative">
                ...
                />
                {searching && <p className="text-sm text-zinc-500 mt-1">Searching...</p>}
                  ...
                  <div className="absolute z-10 w-full mt-1 bg-zinc-100 border border-zinc-200 rounded-lg shadow-xl max-h-60 overflow-y-auto">
                    {searchResults.map((card) => (
                      <button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-2 hover:bg-zinc-100 transition-colors cursor-pointer text-left"
                      >
                        ...
                        <div>
                          ...
                          <p className="text-xs text-zinc-500">{card.id} &middot; {card.rarity}</p>
                        </div>
                      </button>
                    ))}
                  </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 rounded-lg bg-zinc-100 border border-zinc-200 text-zinc-900 focus:outline-none focus:ring-2 focus:ring-orange-500"
            >
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-zinc-600 mb-1.5">Price (USD)</label>
              <div className="relative">
                ...
                <input
                  ...
                  required
                  placeholder="0.00"
                  className="w-full pl-7 pr-4 py-3 rounded-lg bg-zinc-100 border border-zinc-200 text-zinc-900 focus:outline-none focus:ring-2 focus:ring-orange-500"
                />
              </div>
            </div>
            <div>
              <label className="block text-sm font-medium text-zinc-600 mb-1.5">Quantity</label>
              <input
                type="number"
                min="1"
                value={quantity}
