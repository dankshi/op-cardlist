  ...
  return (
    <div className="space-y-3">
      <button
        ...
        className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-lg border border-zinc-200 bg-zinc-100 hover:bg-zinc-100 text-zinc-900 transition-colors cursor-pointer"
      >
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-lg border border-zinc-200 bg-[#5865F2] hover:bg-[#4752C4] text-white transition-colors cursor-pointer"
      >
...
export function FormInput({
  ...
  return (
    <div>
      <label htmlFor={name} className="block text-sm font-medium text-zinc-600 mb-1.5">
        {label}
      </label>
      <input
        id={name}
...
export function AuthError({ message }: { message?: string }) {
  ...
  return (
    <div className="p-3 rounded-lg bg-red-500/10 border border-red-200 text-red-400 text-sm">
      {message}
    </div>
  )
}
